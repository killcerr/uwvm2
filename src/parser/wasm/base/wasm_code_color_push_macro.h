...
#define WASM_WIN32_COLOR_RST_ALL(stream)                                                                                                                    \
    ::utils::ansies::win32_text_attr { stream, ::utils::ansies::text_attr::foreground_rst_all }
