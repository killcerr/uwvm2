...
export namespace uwvm::global
{
    ...
    inline ::uwvm::consolecp::set_native_console_io_cp_to_utf8 set_native_console_io_cp_to_utf8_ele{};
    inline ::uwvm::consolecp::enable_native_ansi enable_native_ansi_ele{};
#endif
}  // namespace uwvm
