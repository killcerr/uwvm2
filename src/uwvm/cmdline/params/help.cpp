...
namespace uwvm::cmdline::paras::details
{
    ...
    inline void help_output_singal_cate(::utils::cmdline::categorization cate) noexcept
    {
        for(auto const p: ::uwvm::cmdline::parameters)
        {
            ...
            ::fast_io::io::perr(::uwvm::log_output,
                                ...
                                ::fast_io::mnp::cond(::uwvm::utils::ansies::put_color, UWVM_COLOR_U8_LT_PURPLE),
                                u8"Usage: ",
                                ::fast_io::mnp::cond(::uwvm::utils::ansies::put_color, UWVM_COLOR_U8_WHITE),
                                u8"[",
                                ::fast_io::mnp::cond(::uwvm::utils::ansies::put_color, UWVM_COLOR_U8_GREEN),
                                                                               ...
                                                                               ::utils::cmdline::parameter_parsing_results* para_end) noexcept
    {
        ...
        {
            ::fast_io::io::perr(::uwvm::log_output, ::fast_io::mnp::cond(::uwvm::utils::ansies::put_color, UWVM_COLOR_U8_RST_ALL_AND_SET_WHITE), u8"Arguments:\n");
