...
UWVM_MODULE_EXPORT namespace ulte::uwvm::custom
{
...
#if defined(UWVM_GIT_COMMIT_ID) && defined(UWVM_GIT_REMOTE_URL) && defined(UWVM_GIT_COMMIT_DATA) && defined(UWVM_GIT_UPSTREAM_BRANCH)
    ...
    inline constexpr ::fast_io::u8string_view git_commit_data{};
