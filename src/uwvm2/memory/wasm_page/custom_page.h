...
{
    inline constexpr ::uwvm2::memory::wasm_page::wasm32_page_size_t set_custom_wasm32_page_size(unsigned page_size_log2) noexcept
    {
        constexpr unsigned max_page_size_log2{::std::numeric_limits<::uwvm2::memory::wasm_page::wasm32_page_size_t>::digits};

        if(page_size_log2 >= max_page_size_log2) [[unlikely]] { ::fast_io::fast_terminate(); }

        return static_cast<::uwvm2::memory::wasm_page::wasm32_page_size_t>(static_cast<::uwvm2::memory::wasm_page::wasm32_page_size_t>(1u) << page_size_log2);
    }

    inline constexpr ::uwvm2::memory::wasm_page::wasm64_page_size_t set_custom_wasm64_page_size(unsigned page_size_log2) noexcept
    {
        constexpr unsigned max_page_size_log2{::std::numeric_limits<::uwvm2::memory::wasm_page::wasm64_page_size_t>::digits};
