...
# define UWVM_MODULE_EXPORT
    ...
    UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::abi { static_assert(alignof(::uwvm2::parser::wasm::standard::wasm1::type::wasm_i8) == 1uz, "non-wasi data layout");
