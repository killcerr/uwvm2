...
# endif
        {
            data_sync(curr_fd_win32_io_observer);
        }
# ifdef UWVM_CPP_EXCEPTIONS
        catch(::fast_io::error e)
        {
            switch(e.domain)
            {
                case ::fast_io::win32_domain_value:
                {
                    switch(e.code)
                    {
                        case ERROR_INVALID_HANDLE: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::ebadf;
                        case ERROR_ACCESS_DENIED: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::eacces;
                        case ERROR_INVALID_FUNCTION: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::enosys;
                        case ERROR_NOT_SUPPORTED: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::enotsup;
                        case ERROR_WRITE_PROTECT: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::erofs;
                        case ERROR_INVALID_PARAMETER: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::einval;
                        case ERROR_IO_DEVICE: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::eio;
                        case ERROR_DEVICE_NOT_READY: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::enodev;
                        case ERROR_GEN_FAILURE: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::eio;
                        case ERROR_INVALID_USER_BUFFER: return ::uwvm2::imported::wasi::wasip1::abi::errno_t::efault;
