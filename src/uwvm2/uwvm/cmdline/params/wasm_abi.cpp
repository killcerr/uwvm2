...
namespace uwvm2::uwvm::cmdline::params::details
{
    UWVM_GNU_COLD extern ::uwvm2::utils::cmdline::parameter_return_type
        wasm_abi_callback([[maybe_unused]] ::uwvm2::utils::cmdline::parameter_parsing_results* para_begin,
                          ...
                          ::uwvm2::utils::cmdline::parameter_parsing_results* para_end) noexcept
    {
        ...
        else if(currp1_str == u8"wasix") { ::uwvm2::uwvm::wasm::storage::execute_wasm_abi = ::uwvm2::uwvm::wasm::base::abi::wasix; }
        else [[unlikely]]
        {
            ::fast_io::io::perr(::uwvm2::uwvm::u8log_output,
                                ::fast_io::mnp::cond(::uwvm2::uwvm::utils::ansies::put_color, UWVM_COLOR_U8_RST_ALL_AND_SET_WHITE),
