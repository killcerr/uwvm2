...
namespace uwvm2::uwvm::cmdline::params::details
{
                              ...
                              ::uwvm2::utils::cmdline::parameter_parsing_results* para_end) noexcept
    {
        ...
        // Check for out-of-bounds and not-argument
        if(auto currp2{para_curr + 2u}; 
           !(currp2 == para_end || currp2->type != ::uwvm2::utils::cmdline::parameter_parsing_results_type::arg)) [[unlikely]]
        {
            // [... curr arg arg] ...
            // [    safe        ] unsafe (could be the module_end)
            //               ^^ currp2
        ...
        auto const load_wasm_file_rtl{::uwvm2::uwvm::wasm::loader::load_wasm_file(new_preloaded_wasm,
                                                                                  file_name,
                                                                                  rename_module_name,
