...
constexpr auto get_duplicate_imports_or_exports_type_name =
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                get_duplicate_imports_or_exports_type_name.template operator()<char>(errout.err.err_selectable.duplic_imports_or_exports.type),
                "): \"",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::code_cvt(errout.err.err_selectable.duplic_imports_or_exports.module_name),
                UWVM_WIN32_TEXTATTR_WHITE,
                ".",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::code_cvt(errout.err.err_selectable.duplic_imports_or_exports.extern_name),
                UWVM_WIN32_TEXTATTR_WHITE,
                "\".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                get_duplicate_imports_or_exports_type_name.template operator()<wchar_t>(errout.err.err_selectable.duplic_imports_or_exports.type),
                L"): \"",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::code_cvt(errout.err.err_selectable.duplic_imports_or_exports.module_name),
                UWVM_WIN32_TEXTATTR_WHITE,
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                get_duplicate_imports_or_exports_type_name.template operator()<char8_t>(errout.err.err_selectable.duplic_imports_or_exports.type),
                u8"): \"",
                UWVM_WIN32_TEXTATTR_CYAN,
                errout.err.err_selectable.duplic_imports_or_exports.module_name,
                UWVM_WIN32_TEXTATTR_WHITE,
                u8".",
                UWVM_WIN32_TEXTATTR_CYAN,
                errout.err.err_selectable.duplic_imports_or_exports.extern_name,
                UWVM_WIN32_TEXTATTR_WHITE,
                u8"\".",
                UWVM_WIN32_TEXTATTR_RST_ALL);
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                get_duplicate_imports_or_exports_type_name.template operator()<char16_t>(errout.err.err_selectable.duplic_imports_or_exports.type),
                u"): \"",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::code_cvt(errout.err.err_selectable.duplic_imports_or_exports.module_name),
                UWVM_WIN32_TEXTATTR_WHITE,
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(
                ...
                ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                U") Duplicate imports of the same import type (",
                get_duplicate_imports_or_exports_type_name.template operator()<char32_t>(errout.err.err_selectable.duplic_imports_or_exports.type),
                U"): \"",
                UWVM_WIN32_TEXTATTR_CYAN,
                ::fast_io::mnp::code_cvt(errout.err.err_selectable.duplic_imports_or_exports.module_name),
                UWVM_WIN32_TEXTATTR_WHITE,
