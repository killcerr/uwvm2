...
#define WASM_WIN32_COLOR_RST_ALL(stream)                                                                                                                       \
    ::uwvm2::utils::ansies::win32_text_attr { stream, ::uwvm2::utils::ansies::text_attr::foreground_rst_all }
