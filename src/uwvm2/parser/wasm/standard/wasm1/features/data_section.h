...
UWVM_MODULE_EXPORT namespace uwvm2::parser::wasm::standard::wasm1::features
{
    struct data_section_storage_t UWVM_TRIVIALLY_RELOCATABLE_IF_ELIGIBLE
    {
        ...
        ::fast_io::vector<::uwvm2::parser::wasm::standard::wasm1::features::wasm_data_t> datas{};
    };
    ...
    inline constexpr void handle_binfmt_ver1_extensible_section_define(
        [[maybe_unused]] ::uwvm2::parser::wasm::concepts::feature_reserve_type_t<data_section_storage_t> sec_adl,
        ...
        ::std::byte const* const sec_id_module_ptr) UWVM_THROWS
    {
        ...
        auto& datasec{::uwvm2::parser::wasm::concepts::operation::get_first_type_in_tuple<data_section_storage_t>(module_storage.sections)};
        ...
        while(section_curr != section_end) [[likely]]
        {
            ...
            ::uwvm2::parser::wasm::standard::wasm1::features::wasm_data_t wdt{};

            ::uwvm2::parser::wasm::standard::wasm1::type::wasm_u32 data_memory_idx;  // No initialization necessary

            auto const [data_memory_idx_next, data_memory_idx_err]{::fast_io::parse_by_scan(reinterpret_cast<char8_t_const_may_alias_ptr>(section_curr),
                                                                                            reinterpret_cast<char8_t_const_may_alias_ptr>(section_end),
                                                                                            ::fast_io::mnp::leb128_get(data_memory_idx))};

            if(data_memory_idx_err != ::fast_io::parse_code::ok) [[unlikely]]
            {
                err.err_curr = section_curr;
                err.err_code = ::uwvm2::parser::wasm::base::wasm_parse_error_code::invalid_data_memory_idx;
                ::uwvm2::parser::wasm::base::throw_wasm_parse_code(data_memory_idx_err);
            }
            ...
            section_curr = reinterpret_cast<::std::byte const*>(data_memory_idx_next);
            ...
            datasec.datas.push_back_unchecked(::std::move(wdt));
        }
...
{
    template <>
    struct is_trivially_copyable_or_relocatable<::uwvm2::parser::wasm::standard::wasm1::features::data_section_storage_t>
    {
        inline static constexpr bool value = true;
    };

    template <>
    struct is_zero_default_constructible<::uwvm2::parser::wasm::standard::wasm1::features::data_section_storage_t>
    {
        inline static constexpr bool value = true;
    };
}
