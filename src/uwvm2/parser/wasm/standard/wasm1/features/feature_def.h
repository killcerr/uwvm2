        ...
        inline constexpr vectypeidx_minimize_storage_t(vectypeidx_minimize_storage_t&& other) noexcept : mode{other.mode}
        {
            ...
            switch(this->mode)
            {
                ...
                case vectypeidx_minimize_storage_mode::u8_vector:
                {
                    ...
                    ::new(::std::addressof(this->storage.typeidx_u8_vector))decltype(this->storage.typeidx_u8_vector){::std::move(other.storage.typeidx_u8_vector)};
                    break;
                }
                case vectypeidx_minimize_storage_mode::u16_vector:
                {
                    // move constructor, placement new
                    ::new(::std::addressof(this->storage.typeidx_u16_vector))decltype(this->storage.typeidx_u16_vector){::std::move(other.storage.typeidx_u16_vector)};
                    break;
                }
                case vectypeidx_minimize_storage_mode::u32_vector:
                {
                    // move constructor, placement new
                    ::new(::std::addressof(this->storage.typeidx_u32_vector))decltype(this->storage.typeidx_u32_vector){::std::move(other.storage.typeidx_u32_vector)};
                    break;
                }
                [[unlikely]] default:
                {
...
UWVM_MODULE_EXPORT namespace uwvm2::parser::wasm::standard::wasm1::features
{
    ...
    struct wasm1_element_t UWVM_TRIVIALLY_RELOCATABLE_IF_ELIGIBLE
    {
        inline static constexpr ::std::size_t sizeof_storage_u{
            ::uwvm2::parser::wasm::concepts::operation::get_union_size<typeidx_u8_view_t, ::uwvm2::parser::wasm::standard::wasm1::features::wasm1_elem_storage_t>()};
        ...
        // In wasm1, type stands for table index, which conceptually can be any value, but since the standard specifies only 1 table, it can only be 0. Here union does not need to make any type-safe judgments since there is only one type.
