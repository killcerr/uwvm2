...
int main()
{
    ...
    fd4.file_fd = ::fast_io::native_file{u8"test_fd_fdstat_set_rights_wasm64.tmp",
    ...
    auto read_rights = [&] (wasi_posix_fd_wasm64_t fd, rights_wasm64_t& out_base, rights_wasm64_t& out_inh) {
        ...
        u_rights const base_u = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<u_rights>(memory, static_cast<wasi_void_ptr_wasm64_t>(stat_ptr + 8u));
        u_rights const inh_u = ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm64<u_rights>(memory, static_cast<wasi_void_ptr_wasm64_t>(stat_ptr + 16u));
    ...
    // Case 5: inheriting may contain bits that base does not (allowed by spec)
    {
        ...
        fd5.file_fd = ::fast_io::native_file{u8"test_fd_fdstat_set_rights_wasm64_case5.tmp",
                                             ::fast_io::open_mode::out | ::fast_io::open_mode::creat | ::fast_io::open_mode::trunc};
    ...
    // Case 6: ebadf after fd_close
    {
        ...
        fde.file_fd = ::fast_io::native_file{u8"test_fd_fdstat_set_rights_wasm64_close.tmp",
                                             ::fast_io::open_mode::out | ::fast_io::open_mode::creat | ::fast_io::open_mode::trunc};
