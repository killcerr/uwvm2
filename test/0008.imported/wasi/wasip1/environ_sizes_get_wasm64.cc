...
int main()
{
    ...
    constexpr wasi_void_ptr_t envc_ptr{4096u};
    constexpr wasi_void_ptr_t envbuf_size_ptr{6144u};
    ...
    wasi_size_t const expect_envc{1u};
    wasi_size_t const expect_bufsz{static_cast<wasi_size_t>(e0.size() + 1uz)};
